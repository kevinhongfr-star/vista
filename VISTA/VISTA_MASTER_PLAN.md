...
> Generated: 2026-07-11 | Updated: 2026-07-12 | Total: 509 tickets across 7 versions
...
| [Wave 1.7 B2C→B2B Intelligence Spec](spec_wave1.7_b2c_portal.md) | 23KB | 10 tickets (BC-01→BC-10) — B2C ingestion, B2B scoring, conversion pipeline, analytics |
...
**Total estimated: ~233 days** (sequential), parallelizable to ~80 days with 3 devs
...
| Wave 1.7 B2C→B2B Intelligence | 3 new + 1 altered | 📋 Migration Ready (v2.0) |
| **Total** | **42 tables** | **39 live + 3 pending** |
...
**B2C→B2B Intelligence (Wave 1.7 v2.0)**: vista_b2c_leads, vista_b2c_events, vista_b2c_conversions
...
### Wave 1.7 — B2C → B2B Conversion Intelligence (10 tickets: BC-01 to BC-10)

> **Triggered by:** LYC Pricing Strategy V2 (2026-07-12) | **CORRECTED SCOPE v2.0**
> **Focus:** VISTA ingests B2C user data from DEX AI portal, flags B2B potential, manages conversion pipeline
> **NOT in scope:** B2C chat, credits, billing, assessments (DEX AI portal is a separate product)
> **Migration SQL:** `run_this_wave1.7_migration.sql`
> **Spec:** `spec_wave1.7_b2c_portal.md`

| # | Ticket | Domain | Estimate |
|---|--------|--------|----------|
| BC-01 | B2C Lead Ingestion API (REST endpoint for DEX AI portal) | Ingestion | 2d |
| BC-02 | B2C Event Webhook Handler (real-time events, HMAC auth) | Ingestion | 1.5d |
| BC-03 | B2B Potential Scoring Rules (configurable 0-100 score, 7 dimensions) | Signals | 2d |
| BC-04 | B2C Lead Flagging & Alerts (auto-flag at threshold, BD notification) | Signals | 1d |
| BC-05 | B2C Lead Pipeline — Kanban (6 stages: B2C User → Flagged → Promoted) | Pipeline | 2d |
| BC-06 | B2C Lead Profile & Context Panel (B2C history + BD context) | Pipeline | 1.5d |
| BC-07 | B2C → B2B Promotion Engine (auto-create contact, transfer history) | Pipeline | 2d |
| BC-08 | B2C → B2B Conversion Analytics Dashboard | Analytics | 2d |
| BC-09 | B2C Revenue Attribution (pre-conversion spend, ROI) | Analytics | 1d |
| BC-10 | DEX AI Integration Config (admin: API keys, thresholds, weights) | Config | 0.5d |
