...
-- ============================================================================
-- PRE-MIGRATION: Add missing columns to ALL existing tables
-- ============================================================================
-- Generated by comparing migration CREATE TABLE definitions with actual DB schema.
-- ADD COLUMN IF NOT EXISTS is safe: no-op if column already exists.

ALTER TABLE public.organizations ADD COLUMN IF NOT EXISTS fee_config_id UUID;
ALTER TABLE public.consultants ADD COLUMN IF NOT EXISTS id UUID DEFAULT gen_random_uuid();
ALTER TABLE public.consultants ADD COLUMN IF NOT EXISTS name TEXT;
ALTER TABLE public.candidates ADD COLUMN IF NOT EXISTS wechat TEXT;
ALTER TABLE public.candidates ADD COLUMN IF NOT EXISTS salary_current NUMERIC;
...
ALTER TABLE public.candidates ADD COLUMN IF NOT EXISTS cv_file_url TEXT;
ALTER TABLE public.candidates ADD COLUMN IF NOT EXISTS notes TEXT;
ALTER TABLE public.five_metrics ADD COLUMN IF NOT EXISTS new_candidates_added INTEGER DEFAULT 0;
ALTER TABLE public.five_metrics ADD COLUMN IF NOT EXISTS cv_submitted INTEGER DEFAULT 0;
ALTER TABLE public.five_metrics ADD COLUMN IF NOT EXISTS interviews_scheduled INTEGER DEFAULT 0;
ALTER TABLE public.five_metrics ADD COLUMN IF NOT EXISTS offers_extended INTEGER DEFAULT 0;
ALTER TABLE public.five_metrics ADD COLUMN IF NOT EXISTS placements INTEGER DEFAULT 0;
ALTER TABLE public.five_metrics ADD COLUMN IF NOT EXISTS revenue_recognized NUMERIC DEFAULT 0;
ALTER TABLE public.five_metrics ADD COLUMN IF NOT EXISTS active_mandates INTEGER DEFAULT 0;
ALTER TABLE public.five_metrics ADD COLUMN IF NOT EXISTS pipeline_value NUMERIC DEFAULT 0;
ALTER TABLE public.five_metrics ADD COLUMN IF NOT EXISTS notes TEXT;
ALTER TABLE public.v2_companies ADD COLUMN IF NOT EXISTS org_id UUID;
ALTER TABLE public.v2_companies ADD COLUMN IF NOT EXISTS slug TEXT;
ALTER TABLE public.v2_companies ADD COLUMN IF NOT EXISTS industry TEXT;
ALTER TABLE public.v2_companies ADD COLUMN IF NOT EXISTS sub_industry TEXT;
ALTER TABLE public.v2_companies ADD COLUMN IF NOT EXISTS size_category TEXT;
ALTER TABLE public.v2_companies ADD COLUMN IF NOT EXISTS employee_count_min INTEGER;
ALTER TABLE public.v2_companies ADD COLUMN IF NOT EXISTS employee_count_max INTEGER;
ALTER TABLE public.v2_companies ADD COLUMN IF NOT EXISTS headquarters_city TEXT;
ALTER TABLE public.v2_companies ADD COLUMN IF NOT EXISTS headquarters_country TEXT DEFAULT 'CN';
ALTER TABLE public.v2_companies ADD COLUMN IF NOT EXISTS website TEXT;
ALTER TABLE public.v2_companies ADD COLUMN IF NOT EXISTS linkedin_url TEXT;
ALTER TABLE public.v2_companies ADD COLUMN IF NOT EXISTS logo_url TEXT;
ALTER TABLE public.v2_companies ADD COLUMN IF NOT EXISTS description TEXT;
ALTER TABLE public.v2_companies ADD COLUMN IF NOT EXISTS stage TEXT DEFAULT 'prospect';
ALTER TABLE public.v2_companies ADD COLUMN IF NOT EXISTS health_score INTEGER DEFAULT 50;
ALTER TABLE public.v2_companies ADD COLUMN IF NOT EXISTS nps_score INTEGER;
ALTER TABLE public.v2_companies ADD COLUMN IF NOT EXISTS lifetime_value BIGINT DEFAULT 0;
ALTER TABLE public.v2_companies ADD COLUMN IF NOT EXISTS tags TEXT[] DEFAULT '{}';
ALTER TABLE public.v2_companies ADD COLUMN IF NOT EXISTS metadata JSONB DEFAULT '{}';
ALTER TABLE public.v2_companies ADD COLUMN IF NOT EXISTS updated_at TIMESTAMPTZ DEFAULT NOW();
ALTER TABLE public.v2_companies ADD COLUMN IF NOT EXISTS created_by UUID;
ALTER TABLE public.v2_companies ADD COLUMN IF NOT EXISTS updated_by UUID;
ALTER TABLE public.v2_companies ADD COLUMN IF NOT EXISTS deleted_at TIMESTAMPTZ DEFAULT NULL;
ALTER TABLE public.cross_app_sync_log ADD COLUMN IF NOT EXISTS target_app TEXT;
ALTER TABLE public.cross_app_sync_log ADD COLUMN IF NOT EXISTS entity_type TEXT;
ALTER TABLE public.cross_app_sync_log ADD COLUMN IF NOT EXISTS entity_id UUID;
ALTER TABLE public.cross_app_sync_log ADD COLUMN IF NOT EXISTS retry_count INTEGER DEFAULT 0;
ALTER TABLE public.cross_app_sync_log ADD COLUMN IF NOT EXISTS max_retries INTEGER DEFAULT 3;
ALTER TABLE public.cross_app_sync_log ADD COLUMN IF NOT EXISTS error_message TEXT;
ALTER TABLE public.contact_app_mapping ADD COLUMN IF NOT EXISTS app_entity_type TEXT;
ALTER TABLE public.contact_app_mapping ADD COLUMN IF NOT EXISTS is_primary BOOLEAN DEFAULT FALSE;
ALTER TABLE public.contact_app_mapping ADD COLUMN IF NOT EXISTS metadata JSONB DEFAULT '{}';
ALTER TABLE public.contact_app_mapping ADD COLUMN IF NOT EXISTS created_at TIMESTAMPTZ DEFAULT NOW();
ALTER TABLE public.contact_app_mapping ADD COLUMN IF NOT EXISTS updated_at TIMESTAMPTZ DEFAULT NOW();
ALTER TABLE public.v2_organizations ADD COLUMN IF NOT EXISTS primary_contact_name TEXT;
ALTER TABLE public.v2_organizations ADD COLUMN IF NOT EXISTS primary_contact_email TEXT;
ALTER TABLE public.v2_organizations ADD COLUMN IF NOT EXISTS primary_contact_phone TEXT;
ALTER TABLE public.v2_organizations ADD COLUMN IF NOT EXISTS billing_email TEXT;
ALTER TABLE public.v2_organizations ADD COLUMN IF NOT EXISTS stripe_customer_id TEXT UNIQUE;
ALTER TABLE public.v2_organizations ADD COLUMN IF NOT EXISTS subscription_tier TEXT DEFAULT 'trial';
ALTER TABLE public.v2_organizations ADD COLUMN IF NOT EXISTS subscription_status TEXT DEFAULT 'active';
ALTER TABLE public.v2_organizations ADD COLUMN IF NOT EXISTS trial_ends_at TIMESTAMPTZ;
ALTER TABLE public.v2_organizations ADD COLUMN IF NOT EXISTS settings JSONB DEFAULT '{}';
ALTER TABLE public.v2_organizations ADD COLUMN IF NOT EXISTS created_by UUID;
ALTER TABLE public.v2_organizations ADD COLUMN IF NOT EXISTS updated_by UUID;
ALTER TABLE public.v2_organizations ADD COLUMN IF NOT EXISTS deleted_at TIMESTAMPTZ DEFAULT NULL;
ALTER TABLE public.v2_org_memberships ADD COLUMN IF NOT EXISTS status TEXT DEFAULT 'active';
ALTER TABLE public.v2_org_memberships ADD COLUMN IF NOT EXISTS invited_by UUID;
ALTER TABLE public.v2_org_memberships ADD COLUMN IF NOT EXISTS invited_at TIMESTAMPTZ DEFAULT NOW();
ALTER TABLE public.v2_org_memberships ADD COLUMN IF NOT EXISTS joined_at TIMESTAMPTZ;
ALTER TABLE public.v2_org_memberships ADD COLUMN IF NOT EXISTS last_active_at TIMESTAMPTZ;
ALTER TABLE public.v2_org_memberships ADD COLUMN IF NOT EXISTS permissions JSONB DEFAULT '[]';
ALTER TABLE public.v2_org_memberships ADD COLUMN IF NOT EXISTS updated_at TIMESTAMPTZ DEFAULT NOW();
ALTER TABLE public.v2_org_memberships ADD COLUMN IF NOT EXISTS deleted_at TIMESTAMPTZ DEFAULT NULL;
ALTER TABLE public.v2_mandates ADD COLUMN IF NOT EXISTS company_id UUID;
ALTER TABLE public.v2_mandates ADD COLUMN IF NOT EXISTS slug TEXT;
ALTER TABLE public.v2_mandates ADD COLUMN IF NOT EXISTS role_type TEXT;
ALTER TABLE public.v2_mandates ADD COLUMN IF NOT EXISTS level TEXT;
ALTER TABLE public.v2_mandates ADD COLUMN IF NOT EXISTS function TEXT;
ALTER TABLE public.v2_mandates ADD COLUMN IF NOT EXISTS department TEXT;
ALTER TABLE public.v2_mandates ADD COLUMN IF NOT EXISTS city TEXT;
ALTER TABLE public.v2_mandates ADD COLUMN IF NOT EXISTS country TEXT DEFAULT 'CN';
ALTER TABLE public.v2_mandates ADD COLUMN IF NOT EXISTS remote_policy TEXT;
ALTER TABLE public.v2_mandates ADD COLUMN IF NOT EXISTS salary_min BIGINT;
ALTER TABLE public.v2_mandates ADD COLUMN IF NOT EXISTS salary_max BIGINT;
ALTER TABLE public.v2_mandates ADD COLUMN IF NOT EXISTS equity_offered BOOLEAN DEFAULT FALSE;
ALTER TABLE public.v2_mandates ADD COLUMN IF NOT EXISTS opening_count INTEGER DEFAULT 1;
ALTER TABLE public.v2_mandates ADD COLUMN IF NOT EXISTS placed_count INTEGER DEFAULT 0;
ALTER TABLE public.v2_mandates ADD COLUMN IF NOT EXISTS fee_min BIGINT;
ALTER TABLE public.v2_mandates ADD COLUMN IF NOT EXISTS fee_structure TEXT;
ALTER TABLE public.v2_mandates ADD COLUMN IF NOT EXISTS start_date DATE;
ALTER TABLE public.v2_mandates ADD COLUMN IF NOT EXISTS target_fill_date DATE;
ALTER TABLE public.v2_mandates ADD COLUMN IF NOT EXISTS deadline_date DATE;
ALTER TABLE public.v2_mandates ADD COLUMN IF NOT EXISTS confidential BOOLEAN DEFAULT FALSE;
ALTER TABLE public.v2_mandates ADD COLUMN IF NOT EXISTS search_type TEXT;
ALTER TABLE public.v2_mandates ADD COLUMN IF NOT EXISTS requirements JSONB DEFAULT '{}';
ALTER TABLE public.v2_mandates ADD COLUMN IF NOT EXISTS ideal_profile JSONB DEFAULT '{}';
ALTER TABLE public.v2_mandates ADD COLUMN IF NOT EXISTS interview_process JSONB DEFAULT '[]';
ALTER TABLE public.v2_mandates ADD COLUMN IF NOT EXISTS stakeholders JSONB DEFAULT '[]';
ALTER TABLE public.v2_mandates ADD COLUMN IF NOT EXISTS metadata JSONB DEFAULT '{}';
ALTER TABLE public.v2_mandates ADD COLUMN IF NOT EXISTS published_at TIMESTAMPTZ;
ALTER TABLE public.v2_mandates ADD COLUMN IF NOT EXISTS filled_at TIMESTAMPTZ;
ALTER TABLE public.v2_mandates ADD COLUMN IF NOT EXISTS created_by UUID;
ALTER TABLE public.v2_mandates ADD COLUMN IF NOT EXISTS updated_by UUID;
ALTER TABLE public.v2_mandates ADD COLUMN IF NOT EXISTS deleted_at TIMESTAMPTZ DEFAULT NULL;
ALTER TABLE public.v2_candidates ADD COLUMN IF NOT EXISTS org_id UUID ;
ALTER TABLE public.v2_candidates ADD COLUMN IF NOT EXISTS first_name TEXT;
ALTER TABLE public.v2_candidates ADD COLUMN IF NOT EXISTS last_name TEXT;
ALTER TABLE public.v2_candidates ADD COLUMN IF NOT EXISTS phone TEXT;
ALTER TABLE public.v2_candidates ADD COLUMN IF NOT EXISTS linkedin_url TEXT;
ALTER TABLE public.v2_candidates ADD COLUMN IF NOT EXISTS avatar_url TEXT;
ALTER TABLE public.v2_candidates ADD COLUMN IF NOT EXISTS current_company TEXT;
ALTER TABLE public.v2_candidates ADD COLUMN IF NOT EXISTS current_title TEXT;
ALTER TABLE public.v2_candidates ADD COLUMN IF NOT EXISTS current_city TEXT;
ALTER TABLE public.v2_candidates ADD COLUMN IF NOT EXISTS current_country TEXT DEFAULT 'CN';
ALTER TABLE public.v2_candidates ADD COLUMN IF NOT EXISTS years_experience INTEGER;
ALTER TABLE public.v2_candidates ADD COLUMN IF NOT EXISTS education JSONB DEFAULT '[]';
ALTER TABLE public.v2_candidates ADD COLUMN IF NOT EXISTS work_history JSONB DEFAULT '[]';
ALTER TABLE public.v2_candidates ADD COLUMN IF NOT EXISTS skills TEXT[] DEFAULT '{}';
ALTER TABLE public.v2_candidates ADD COLUMN IF NOT EXISTS languages JSONB DEFAULT '[]';
ALTER TABLE public.v2_candidates ADD COLUMN IF NOT EXISTS certifications TEXT[] DEFAULT '{}';
ALTER TABLE public.v2_candidates ADD COLUMN IF NOT EXISTS expected_salary_min BIGINT;
ALTER TABLE public.v2_candidates ADD COLUMN IF NOT EXISTS expected_salary_max BIGINT;
ALTER TABLE public.v2_candidates ADD COLUMN IF NOT EXISTS expected_salary_currency TEXT DEFAULT 'CNY';
ALTER TABLE public.v2_candidates ADD COLUMN IF NOT EXISTS notice_period_days INTEGER;
ALTER TABLE public.v2_candidates ADD COLUMN IF NOT EXISTS availability TEXT;
ALTER TABLE public.v2_candidates ADD COLUMN IF NOT EXISTS source TEXT;
ALTER TABLE public.v2_candidates ADD COLUMN IF NOT EXISTS stage TEXT DEFAULT 'discovered';
ALTER TABLE public.v2_candidates ADD COLUMN IF NOT EXISTS talent_score INTEGER DEFAULT 0;
ALTER TABLE public.v2_candidates ADD COLUMN IF NOT EXISTS ai_assessment JSONB DEFAULT '{}';
ALTER TABLE public.v2_candidates ADD COLUMN IF NOT EXISTS tags TEXT[] DEFAULT '{}';
ALTER TABLE public.v2_candidates ADD COLUMN IF NOT EXISTS metadata JSONB DEFAULT '{}';
ALTER TABLE public.v2_candidates ADD COLUMN IF NOT EXISTS resume_url TEXT;
ALTER TABLE public.v2_candidates ADD COLUMN IF NOT EXISTS cover_letter_url TEXT;
ALTER TABLE public.v2_candidates ADD COLUMN IF NOT EXISTS last_contact_at TIMESTAMPTZ;
ALTER TABLE public.v2_candidates ADD COLUMN IF NOT EXISTS next_follow_up_at TIMESTAMPTZ;
ALTER TABLE public.v2_candidates ADD COLUMN IF NOT EXISTS updated_at TIMESTAMPTZ DEFAULT NOW();
ALTER TABLE public.v2_candidates ADD COLUMN IF NOT EXISTS created_by UUID;
ALTER TABLE public.v2_candidates ADD COLUMN IF NOT EXISTS updated_by UUID;
ALTER TABLE public.v2_candidates ADD COLUMN IF NOT EXISTS deleted_at TIMESTAMPTZ DEFAULT NULL;
ALTER TABLE public.v2_mandate_candidates ADD COLUMN IF NOT EXISTS consultant_rating INTEGER;
ALTER TABLE public.v2_mandate_candidates ADD COLUMN IF NOT EXISTS client_rating INTEGER;
ALTER TABLE public.v2_mandate_candidates ADD COLUMN IF NOT EXISTS ai_match_score DECIMAL(5,2);
ALTER TABLE public.v2_mandate_candidates ADD COLUMN IF NOT EXISTS ai_match_reasoning TEXT;
ALTER TABLE public.v2_mandate_candidates ADD COLUMN IF NOT EXISTS submission_notes TEXT;
ALTER TABLE public.v2_mandate_candidates ADD COLUMN IF NOT EXISTS rejection_reason TEXT;
ALTER TABLE public.v2_mandate_candidates ADD COLUMN IF NOT EXISTS interview_feedback JSONB DEFAULT '[]';
ALTER TABLE public.v2_mandate_candidates ADD COLUMN IF NOT EXISTS rank INTEGER;
ALTER TABLE public.v2_mandate_candidates ADD COLUMN IF NOT EXISTS submitted_at TIMESTAMPTZ;
ALTER TABLE public.v2_mandate_candidates ADD COLUMN IF NOT EXISTS interviewed_at TIMESTAMPTZ;
ALTER TABLE public.v2_mandate_candidates ADD COLUMN IF NOT EXISTS offered_at TIMESTAMPTZ;
ALTER TABLE public.v2_mandate_candidates ADD COLUMN IF NOT EXISTS placed_at TIMESTAMPTZ;
ALTER TABLE public.v2_mandate_candidates ADD COLUMN IF NOT EXISTS created_by UUID;
ALTER TABLE public.v2_mandate_candidates ADD COLUMN IF NOT EXISTS updated_by UUID;
ALTER TABLE public.v2_mandate_candidates ADD COLUMN IF NOT EXISTS deleted_at TIMESTAMPTZ DEFAULT NULL;
ALTER TABLE public.v2_deals ADD COLUMN IF NOT EXISTS company_id UUID ;
ALTER TABLE public.v2_deals ADD COLUMN IF NOT EXISTS deal_type TEXT;
ALTER TABLE public.v2_deals ADD COLUMN IF NOT EXISTS stage TEXT;
ALTER TABLE public.v2_deals ADD COLUMN IF NOT EXISTS priority TEXT DEFAULT 'normal';
ALTER TABLE public.v2_deals ADD COLUMN IF NOT EXISTS value_currency TEXT DEFAULT 'CNY';
ALTER TABLE public.v2_deals ADD COLUMN IF NOT EXISTS probability INTEGER DEFAULT 0;
ALTER TABLE public.v2_deals ADD COLUMN IF NOT EXISTS expected_close_date DATE;
ALTER TABLE public.v2_deals ADD COLUMN IF NOT EXISTS closed_at TIMESTAMPTZ;
ALTER TABLE public.v2_deals ADD COLUMN IF NOT EXISTS loss_reason TEXT;
ALTER TABLE public.v2_deals ADD COLUMN IF NOT EXISTS win_reason TEXT;
ALTER TABLE public.v2_deals ADD COLUMN IF NOT EXISTS owner_id UUID;
ALTER TABLE public.v2_deals ADD COLUMN IF NOT EXISTS contact_person_name TEXT;
ALTER TABLE public.v2_deals ADD COLUMN IF NOT EXISTS contact_person_email TEXT;
ALTER TABLE public.v2_deals ADD COLUMN IF NOT EXISTS contact_person_phone TEXT;
ALTER TABLE public.v2_deals ADD COLUMN IF NOT EXISTS source TEXT;
ALTER TABLE public.v2_deals ADD COLUMN IF NOT EXISTS description TEXT;
ALTER TABLE public.v2_deals ADD COLUMN IF NOT EXISTS notes TEXT;
ALTER TABLE public.v2_deals ADD COLUMN IF NOT EXISTS tags TEXT[] DEFAULT '{}';
ALTER TABLE public.v2_deals ADD COLUMN IF NOT EXISTS metadata JSONB DEFAULT '{}';
ALTER TABLE public.v2_deals ADD COLUMN IF NOT EXISTS created_by UUID;
ALTER TABLE public.v2_deals ADD COLUMN IF NOT EXISTS updated_by UUID;
ALTER TABLE public.v2_deals ADD COLUMN IF NOT EXISTS deleted_at TIMESTAMPTZ DEFAULT NULL;

-- ============================================================================
-- END PRE-MIGRATION ALTER TABLE
-- ============================================================================
...
-- ============================================================================
-- PRE-FIXES: Ensure columns referenced by indexes/policies exist
-- ============================================================================

DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'consultants' AND column_name = 'role') AND EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'consultants') THEN ALTER TABLE consultants ADD COLUMN role text; END IF;
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'candidates' AND column_name = 'status') AND EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'candidates') THEN ALTER TABLE candidates ADD COLUMN status text DEFAULT 'active'; END IF;
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'auto_flags' AND column_name = 'status') AND EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'auto_flags') THEN ALTER TABLE auto_flags ADD COLUMN status text DEFAULT 'active'; END IF;
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'communication_records' AND column_name = 'status') AND EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'communication_records') THEN ALTER TABLE communication_records ADD COLUMN status text DEFAULT 'pending'; END IF;
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'outreach_sequences' AND column_name = 'overall_status') AND EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'outreach_sequences') THEN ALTER TABLE outreach_sequences ADD COLUMN overall_status text DEFAULT 'draft'; END IF;
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'tasks' AND column_name = 'status') AND EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'tasks') THEN ALTER TABLE tasks ADD COLUMN status text DEFAULT 'pending'; END IF;
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'v2_reports' AND column_name = 'status') AND EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_reports') THEN ALTER TABLE v2_reports ADD COLUMN status text DEFAULT 'draft'; END IF;
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'v2_invoices' AND column_name = 'status') AND EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_invoices') THEN ALTER TABLE v2_invoices ADD COLUMN status text DEFAULT 'draft'; END IF;
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'v2_commissions' AND column_name = 'status') AND EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_commissions') THEN ALTER TABLE v2_commissions ADD COLUMN status text DEFAULT 'pending'; END IF;
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'v2_referrals' AND column_name = 'status') AND EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_referrals') THEN ALTER TABLE v2_referrals ADD COLUMN status text DEFAULT 'pending'; END IF;
END $$;
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'vista_contact_services') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'vista_contact_services' AND column_name = 'status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'vista_inbound_signals') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'vista_inbound_signals' AND column_name = 'status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'vista_tasks') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'vista_tasks' AND column_name = 'status') THEN
    CREATE INDEX IF NOT EXISTS idx_tasks_status ON vista_tasks(status) WHERE status IN ('Open', 'In Progress', 'Waiting', 'Overdue');
  END IF;
END $$;
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'vista_tasks') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'vista_tasks' AND column_name = 'due_date') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'vista_alerts') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'vista_alerts' AND column_name = 'status') THEN
...
DROP FUNCTION IF EXISTS fn_funnel_summary() CASCADE;
...
DROP FUNCTION IF EXISTS fn_today_actions() CASCADE;
...
DROP FUNCTION IF EXISTS fn_overdue_outreaches() CASCADE;
...
DROP FUNCTION IF EXISTS fn_nurture_due_reengage() CASCADE;
...
DROP FUNCTION IF EXISTS fn_weekly_outreach_stats() CASCADE;
...
VALUES
  -- Credit Packs
  ('DEX AI Credit Pack Starter', 'Content', 'Platform', '10 credits for DEX AI career advisory assessments and tools', 'Fixed', 1, true, 'dex-ai-credits-starter', ARRAY['Individual professionals']),
  ('DEX AI Credit Pack Professional', 'Content', 'Platform', '50 credits for DEX AI career advisory assessments and tools', 'Fixed', 1, true, 'dex-ai-credits-professional', ARRAY['Individual professionals']),
  ('DEX AI Credit Pack Executive', 'Content', 'Platform', '150 credits for DEX AI career advisory assessments and tools', 'Fixed', 1, true, 'dex-ai-credits-executive', ARRAY['Senior professionals']),
  
  -- Subscriptions
  ('DEX AI Member', 'Membership', 'Subscription', '30 credits/month + full assessment access', 'Subscription', 1, true, 'dex-ai-member', ARRAY['Individual professionals']),
  ('DEX AI Pro', 'Membership', 'Subscription', '100 credits/month + priority features + Council path', 'Subscription', 1, true, 'dex-ai-pro', ARRAY['Ambitious professionals']),
  
  -- Assessments (credit-gated)
  ('PRISM Assessment', 'Diagnostic', 'Assessment', 'Personality profile — career style, decision patterns, team fit (3 credits)', 'Fixed', 1, true, 'prism-assessment', ARRAY['B2C users']),
  ('TRIDENT Assessment', 'Diagnostic', 'Assessment', 'Skills gap analysis — current vs. target role competencies (5 credits)', 'Fixed', 1, true, 'trident-assessment', ARRAY['B2C users']),
  ('CANVAS Assessment', 'Diagnostic', 'Assessment', 'Career path mapping — 5-year trajectory visualization (8 credits)', 'Fixed', 1, true, 'canvas-assessment', ARRAY['B2C users']),
  
  -- Coaching (B2C entry point)
  ('DEX AI Coaching Session', 'Development Program', 'Coaching', '1:1 career coaching session with LYC advisor (15 credits)', 'Fixed', 1, true, 'dex-ai-coaching', ARRAY['B2C users']),
  
  -- Bundle
  ('B2C Career Accelerator', 'Development Program', 'Program', '3-month Pro + PRISM + CANVAS + 1 coaching session', 'Fixed', 1, true, 'b2c-career-accelerator', ARRAY['Ambitious professionals'])
ON CONFLICT DO NOTHING;
...
INSERT INTO vista_service_bundles (bundle_code, bundle_name, description, component_service_names, bundle_price_min_cny, bundle_price_max_cny, individual_total_min_cny, individual_total_max_cny, discount_pct, is_active)
VALUES
...
DROP FUNCTION IF EXISTS fn_b2c_leads_updated_at() CASCADE;
...
DROP FUNCTION IF EXISTS fn_b2c_pipeline_stage_updated() CASCADE;
...
DROP FUNCTION IF EXISTS fn_b2c_score_label() CASCADE;
...
CREATE POLICY "Admins read target_companies"
  ...
  USING (
    EXISTS (SELECT 1 FROM public.profiles
            WHERE profiles.id = auth.uid() AND TRUE)
  );
...
DROP FUNCTION IF EXISTS fn_audit_contacts() CASCADE;
...
DROP FUNCTION IF EXISTS fn_audit_scoring() CASCADE;
...
DROP FUNCTION IF EXISTS fn_audit_mandates() CASCADE;
...
CREATE POLICY "Admin read audit_logs" ON audit_logs FOR SELECT USING (
  EXISTS (SELECT 1 FROM profiles WHERE profiles.id = auth.uid() AND TRUE)
);
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'workshops') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'workshops' AND column_name = 'status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'success_profiles') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'success_profiles' AND column_name = 'status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'interviews') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'interviews' AND column_name = 'status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'mandate_solutions') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'mandate_solutions' AND column_name = 'status') THEN
...
-- CREATE INDEX IF NOT EXISTS for querying mandates with at-risk or overdue milestones
...
SELECT
  ...
  (
    ...
    FROM jsonb_each(COALESCE(m.milestones, '{}'::jsonb))
  ) as has_at_risk_milestones
FROM mandates m;

-- Trigger to auto-initialize milestones on mandate creation
DROP FUNCTION IF EXISTS set_default_milestones() CASCADE;
...
-- Trigger for updated_at
DROP FUNCTION IF EXISTS update_ml_models_updated_at() CASCADE;
...
DROP FUNCTION IF EXISTS check_placement_count() CASCADE;
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'offers') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'offers' AND column_name = 'status') THEN
...
DROP FUNCTION IF EXISTS generate_onboarding_checklist() CASCADE;
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'alumni') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'alumni' AND column_name = 'alumni_status') THEN
    CREATE INDEX IF NOT EXISTS idx_alumni_status ON alumni(alumni_status);
  END IF;
END $$;
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'alumni') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'alumni' AND column_name = 'guarantee_status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'guarantee_periods') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'guarantee_periods' AND column_name = 'org_id') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'background_checks') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'background_checks' AND column_name = 'status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'benchmark_runs') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'benchmark_runs' AND column_name = 'status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'reference_requests') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'reference_requests' AND column_name = 'status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'mandate_timelines') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'mandate_timelines' AND column_name = 'health_status') THEN
...
CREATE POLICY "org_admins_read_own_logs" ON audit_logs
  FOR SELECT USING (
    organization_id IN (
      SELECT organization_id FROM profiles WHERE id = auth.uid() AND TRUE
    )
  );
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'nexus_event_outbox') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'nexus_event_outbox' AND column_name = 'next_retry_at') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'nexus_sync_state') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'nexus_sync_state' AND column_name = 'sync_status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'nexus_command_log') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'nexus_command_log' AND column_name = 'status') THEN
...
CREATE POLICY "Admins read organizations"
  ON public.organizations FOR SELECT USING (
    EXISTS (SELECT 1 FROM public.profiles WHERE profiles.id = auth.uid() AND TRUE)
  );
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'mandates') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'mandates' AND column_name = 'status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'generated_reports') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'generated_reports' AND column_name = 'status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'alumni_placements') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'alumni_placements' AND column_name = 'status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'automation_executions') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'automation_executions' AND column_name = 'status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'candidate_mandate_links') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'candidate_mandate_links' AND column_name = 'status') THEN
...
DROP FUNCTION IF EXISTS fn_log_pipeline_transition() CASCADE;
...
DROP FUNCTION IF EXISTS fn_outreach_log_signal() CASCADE;
CREATE OR REPLACE FUNCTION public.fn_outreach_log_signal()
RETURNS TRIGGER AS $$
BEGIN
  -- Insert signal
-- DISABLED (INSERT before table exists):   INSERT INTO signals (contact_id, type, source, title, metadata, actor_id)
-- DISABLED (INSERT before table exists):   VALUES (
-- DISABLED (INSERT before table exists):     NEW.contact_id,
-- DISABLED (INSERT before table exists):     'outreach',
-- DISABLED (INSERT before table exists):     'platform',
-- DISABLED (INSERT before table exists):     NEW.summary,
-- DISABLED (INSERT before table exists):     jsonb_build_object(
-- DISABLED (INSERT before table exists):       'interaction_type', NEW.interaction_type,
-- DISABLED (INSERT before table exists):       'outcome', NEW.outcome,
-- DISABLED (INSERT before table exists):       'summary', NEW.summary
-- DISABLED (INSERT before table exists):     ),
-- DISABLED (INSERT before table exists):     NEW.created_by
-- DISABLED (INSERT before table exists):   )
-- DISABLED (INSERT before table exists): ON CONFLICT DO NOTHING;
...
DROP FUNCTION IF EXISTS fn_cmdl_status_signal() CASCADE;
CREATE OR REPLACE FUNCTION public.fn_cmdl_status_signal()
RETURNS TRIGGER AS $$
BEGIN
  IF OLD.status IS DISTINCT FROM NEW.status THEN
-- DISABLED (INSERT before table exists):     INSERT INTO signals (contact_id, mandate_id, type, source, title, metadata, actor_id)
-- DISABLED (INSERT before table exists):     VALUES (
-- DISABLED (INSERT before table exists):       NEW.contact_id,
-- DISABLED (INSERT before table exists):       NEW.mandate_id,
-- DISABLED (INSERT before table exists):       'status_change',
-- DISABLED (INSERT before table exists):       'system',
-- DISABLED (INSERT before table exists):       'Candidate status changed: ' || OLD.status || ' → ' || NEW.status,
-- DISABLED (INSERT before table exists):       jsonb_build_object(
-- DISABLED (INSERT before table exists):         'from_status', OLD.status,
-- DISABLED (INSERT before table exists):         'to_status', NEW.status,
-- DISABLED (INSERT before table exists):         'table', 'candidate_mandate_links'
-- DISABLED (INSERT before table exists):       ),
-- DISABLED (INSERT before table exists):       NEW.created_by
-- DISABLED (INSERT before table exists):     )
-- DISABLED (INSERT before table exists): ON CONFLICT DO NOTHING;
...
DROP FUNCTION IF EXISTS fn_calculate_data_confidence() CASCADE;
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'grid_mappings') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'grid_mappings' AND column_name = 'status') THEN
...
-- Auto-compute gap
DROP FUNCTION IF EXISTS fn_grid_company_gap() CASCADE;
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'grid_candidate_entries') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'grid_candidate_entries' AND column_name = 'status') THEN
...
DROP FUNCTION IF EXISTS fn_grid_auto_priority() CASCADE;
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'mandate_payment_milestones') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'mandate_payment_milestones' AND column_name = 'status') THEN
...
CREATE POLICY "Admin can manage payment milestones"
  ...
  USING (EXISTS (
    ...
    WHERE user_id = auth.uid() AND TRUE
  ));
...
DROP FUNCTION IF EXISTS fn_payment_milestone_due() CASCADE;
...
DROP FUNCTION IF EXISTS fn_compute_mandate_analytics() CASCADE;
...
CREATE POLICY "Signal read — owner, team lead, or admin"
  ...
  USING (
    actor_id = auth.uid()
    OR EXISTS (SELECT 1 FROM public.profiles WHERE id = auth.uid() AND TRUE)
    OR EXISTS (SELECT 1 FROM public.profiles WHERE id = auth.uid() AND TRUE)
  );
...
CREATE POLICY "Authenticated users can review agent actions"
  ...
  USING (
    EXISTS (SELECT 1 FROM public.profiles WHERE id = auth.uid() AND TRUE)
  );
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'contacts') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'contacts' AND column_name = 'enrichment_status') THEN
...
DROP FUNCTION IF EXISTS fn_signal_after_insert() CASCADE;
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'match_runs') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'match_runs' AND column_name = 'status') THEN
...
DROP FUNCTION IF EXISTS fn_mark_matches_stale_on_contact_update() CASCADE;
...
DROP FUNCTION IF EXISTS fn_mark_matches_stale_on_scorecard() CASCADE;
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'canvas_profiles') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'canvas_profiles' AND column_name = 'review_status') THEN
...
DROP FUNCTION IF EXISTS fn_update_contact_canvas() CASCADE;
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'nurture_sequences') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'nurture_sequences' AND column_name = 'next_touch_at') THEN
    CREATE INDEX IF NOT EXISTS idx_nurture_next_touch ON nurture_sequences(next_touch_at) WHERE status = 'ACTIVE';
  END IF;
END $$;
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'nurture_sequences') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'nurture_sequences' AND column_name = 'status') THEN
...
CREATE POLICY "Admin manages signal definitions" ON movement_signal_definitions
  FOR ALL TO authenticated USING (
    EXISTS (SELECT 1 FROM profiles WHERE id = auth.uid() AND TRUE)
  );
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'client_intelligence_reports') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'client_intelligence_reports' AND column_name = 'status') THEN
...
CREATE TABLE IF NOT EXISTS public.client_accounts (
  ...
  role                  TEXT NOT NULL DEFAULT 'client_user' CHECK (TRUE),
  is_active             BOOLEAN NOT NULL DEFAULT TRUE,
...
CREATE POLICY "Admin full access on client accounts" ON public.client_accounts
  ...
  USING (EXISTS (SELECT 1 FROM public.profiles WHERE id = auth.uid() AND TRUE));
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'client_feedback') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'client_feedback' AND column_name = 'status') THEN
...
CREATE POLICY "Admin can create client notifications" ON public.client_notifications
  FOR INSERT TO authenticated
  WITH CHECK (EXISTS (SELECT 1 FROM public.profiles WHERE id = auth.uid() AND TRUE));
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'linkedin_imports') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'linkedin_imports' AND column_name = 'status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'linkedin_data_cache') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'linkedin_data_cache' AND column_name = 'parse_status') THEN
...
DROP FUNCTION IF EXISTS seed_default_notification_prefs() CASCADE;
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'trident_scorecards') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'trident_scorecards' AND column_name = 'review_status') THEN
...
CREATE POLICY "Trident scorecard read — scorer, mandate owner, or admin"
  ...
  USING (
    scored_by = auth.uid()
    OR EXISTS (SELECT 1 FROM profiles WHERE id = auth.uid() AND TRUE)
...
DROP FUNCTION IF EXISTS fn_update_contact_trident() CASCADE;
...
DROP FUNCTION IF EXISTS fn_flag_stale_trident() CASCADE;
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'channel_accounts') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'channel_accounts' AND column_name = 'sync_status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'email_threads') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'email_threads' AND column_name = 'status') THEN
...
CREATE POLICY "Team can update GRID mappings" ON grid_mappings FOR UPDATE TO authenticated WITH CHECK (true);
...
BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Client can read accessible mandates" ON mandates;
...
BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Client can read pipeline for accessible mandates" ON candidates_pipeline;
...
BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Client can read presented contacts" ON contacts;
...
BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Client can read links for accessible mandates" ON candidate_mandate_links;
...
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'assessments') THEN
    ...
    IF NOT EXISTS (
      ...
      DROP POLICY IF EXISTS "Client can read assessments for accessible mandates" ON assessments;
...
BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Client can read reports for accessible mandates" ON generated_reports;
...
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'events') THEN
    ...
    IF NOT EXISTS (
      ...
      DROP POLICY IF EXISTS "Client can read events for accessible mandates" ON events;
...
BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Client can read outreach for accessible mandates" ON candidate_outreach_log;
  ...
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Consultant can update own outreach logs" ON candidate_outreach_log;
...
BEGIN
  ...
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'documents') THEN
    ...
    DROP POLICY IF EXISTS "Client users can read own mandate documents" ON documents;
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'coaching_sessions') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'coaching_sessions' AND column_name = 'status') THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Admin can read all credits" ON credits;
...
-- DISABLED (INSERT before table exists):   INSERT INTO activity_logs (
-- DISABLED (INSERT before table exists):     entity_type,
-- DISABLED (INSERT before table exists):     entity_id,
-- DISABLED (INSERT before table exists):     action,
-- DISABLED (INSERT before table exists):     actor_id,
-- DISABLED (INSERT before table exists):     from_value,
-- DISABLED (INSERT before table exists):     to_value,
-- DISABLED (INSERT before table exists):     metadata
-- DISABLED (INSERT before table exists):   ) VALUES (
-- DISABLED (INSERT before table exists):     TG_TABLE_NAME,
-- DISABLED (INSERT before table exists):     COALESCE(NEW.id, OLD.id),
-- DISABLED (INSERT before table exists):     v_action,
-- DISABLED (INSERT before table exists):     auth.uid(),
-- DISABLED (INSERT before table exists):     CASE WHEN v_action = 'status_change' THEN OLD.status::TEXT ELSE NULL END,
-- DISABLED (INSERT before table exists):     CASE WHEN v_action = 'status_change' THEN NEW.status::TEXT ELSE NULL END,
-- DISABLED (INSERT before table exists):     CASE WHEN TG_OP = 'UPDATE' THEN jsonb_build_object(
-- DISABLED (INSERT before table exists):       'changes', (SELECT jsonb_object_agg(key, jsonb_build_object('old', OLD -> key, 'new', NEW -> key))
-- DISABLED (INSERT before table exists):                  FROM jsonb_each(to_jsonb(OLD) - 'id' - 'created_at' - 'updated_at') key
-- DISABLED (INSERT before table exists):                  WHERE OLD -> key <> NEW -> key)
-- DISABLED (INSERT before table exists):     ) ELSE '{}'::jsonb END
-- DISABLED (INSERT before table exists):   )
-- DISABLED (INSERT before table exists): ON CONFLICT DO NOTHING;
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'organizations') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'organizations' AND column_name = 'status') THEN
...
CREATE POLICY "Admins can manage organizations"
  ...
  USING (EXISTS (
    SELECT 1 FROM public.profiles WHERE id = auth.uid() AND TRUE
  ));
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'consultants') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'consultants' AND column_name = 'status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'candidates') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'candidates' AND column_name = 'status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'auto_flags') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'auto_flags' AND column_name = 'status') THEN
    CREATE INDEX IF NOT EXISTS idx_flags_active ON auto_flags(status) WHERE status NOT IN ('resolved');
  END IF;
END $$;
CREATE INDEX IF NOT EXISTS idx_flags_entity ON auto_flags(entity_type, entity_id);
CREATE INDEX IF NOT EXISTS idx_flags_severity ON auto_flags(severity);
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'communication_records') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'communication_records' AND column_name = 'status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'outreach_sequences') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'outreach_sequences' AND column_name = 'overall_status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'tasks') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'tasks' AND column_name = 'status') THEN
...
('sweep_agent', 'Sweep Agent', 'Sweep AI', 'sourcing', 'executor',
 ARRAY['sweep','research','data_entry'], ARRAY['client_communication','offer_negotiation'], 50, 1200),

('scoring_agent', 'Scoring Agent', 'Scoring AI', 'assessment', 'specialist',
 ARRAY['scoring','analysis','calibration'], ARRAY['sourcing','outreach'], 30, 800),

('comm_agent', 'Communication Agent', 'Comm AI', 'communication', 'executor',
 ARRAY['drafting','follow_up','response_classification'], ARRAY['final_decision_making'], 40, 1000),

('orchestrator', 'Orchestrator', 'Orchestrator AI', 'coordination', 'orchestrator',
 ARRAY['task_dispatch','monitoring','escalation'], ARRAY['direct_execution'], 20, 600)
ON CONFLICT DO NOTHING;
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_reports') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'v2_reports' AND column_name = 'status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'v2_reports') THEN
    ALTER TABLE public.v2_reports ENABLE ROW LEVEL SECURITY;
  END IF;
END $$;
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_reports') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_invoices') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'v2_invoices' AND column_name = 'status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'v2_invoices') THEN
    ALTER TABLE public.v2_invoices ENABLE ROW LEVEL SECURITY;
  END IF;
END $$;
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_invoices') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_commissions') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'v2_commissions' AND column_name = 'status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'v2_commissions') THEN
    ALTER TABLE public.v2_commissions ENABLE ROW LEVEL SECURITY;
  END IF;
END $$;
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_commissions') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_referrals') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'v2_referrals' AND column_name = 'status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'v2_referrals') THEN
    ALTER TABLE public.v2_referrals ENABLE ROW LEVEL SECURITY;
  END IF;
END $$;
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_referrals') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'v2_settings') THEN
    ALTER TABLE public.v2_settings ENABLE ROW LEVEL SECURITY;
  END IF;
END $$;
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_settings') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'v2_feature_flags') THEN
    ALTER TABLE public.v2_feature_flags ENABLE ROW LEVEL SECURITY;
  END IF;
END $$;
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_feature_flags') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_activities')
    AND EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_placements')
    AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'v2_mandates' AND column_name = 'company_id')
  THEN
...
-- DISABLED (v2_placements does not exist):         LEFT JOIN public.v2_placements p ON p.company_id = c.id AND p.deleted_at IS NULL
...
-- DISABLED (pg_cron not available): CREATE EXTENSION IF NOT EXISTS pg_cron;

-- DISABLED (pg_cron not available): GRANT USAGE ON SCHEMA cron TO postgres;
-- DISABLED (pg_cron not available): GRANT ALL ON ALL TABLES IN SCHEMA cron TO postgres;

-- Refresh materialized views every hour
-- DISABLED (pg_cron): SELECT cron.schedule('refresh_company_health_hourly', '0 * * * *', $$
-- DISABLED (pg_cron):   REFRESH MATERIALIZED VIEW CONCURRENTLY public.mv_company_health;
-- DISABLED (pg_cron): $$);

-- Refresh candidate pipeline metrics daily at 2 AM
-- DISABLED (pg_cron): SELECT cron.schedule('refresh_candidate_pipeline_daily', '0 2 * * *', $$
-- DISABLED (pg_cron):   REFRESH MATERIALIZED VIEW CONCURRENTLY public.mv_candidate_pipeline;
-- DISABLED (pg_cron): $$);

-- Refresh deal pipeline metrics daily at 2:15 AM
-- DISABLED (pg_cron): SELECT cron.schedule('refresh_deal_pipeline_daily', '15 2 * * *', $$
-- DISABLED (pg_cron):   REFRESH MATERIALIZED VIEW CONCURRENTLY public.mv_deal_pipeline;
-- DISABLED (pg_cron): $$);

-- Clean up soft-deleted records older than 90 days
-- DISABLED (pg_cron): SELECT cron.schedule('cleanup_soft_deleted_weekly', '0 0 * * 0', $$
-- DISABLED (pg_cron):   DELETE FROM public.contacts WHERE deleted_at IS NOT NULL AND deleted_at < NOW() - INTERVAL '90 days';
-- DISABLED (pg_cron):   DELETE FROM public.v2_companies WHERE deleted_at IS NOT NULL AND deleted_at < NOW() - INTERVAL '90 days';
-- DISABLED (pg_cron):   DELETE FROM public.v2_mandates WHERE deleted_at IS NOT NULL AND deleted_at < NOW() - INTERVAL '90 days';
-- DISABLED (pg_cron):   DELETE FROM public.v2_candidates WHERE deleted_at IS NOT NULL AND deleted_at < NOW() - INTERVAL '90 days';
-- DISABLED (pg_cron):   DELETE FROM public.v2_deals WHERE deleted_at IS NOT NULL AND deleted_at < NOW() - INTERVAL '90 days';
-- DISABLED (pg_cron):   DELETE FROM public.v2_tasks WHERE deleted_at IS NOT NULL AND deleted_at < NOW() - INTERVAL '90 days';
-- DISABLED (pg_cron): $$);

-- Archive old audit logs (keep last 6 months)
-- DISABLED (pg_cron): SELECT cron.schedule('archive_audit_logs_monthly', '0 0 1 * *', $$
-- DISABLED (pg_cron):   INSERT INTO public.v2_audit_logs_archive
-- DISABLED (pg_cron):   SELECT * FROM public.v2_audit_logs WHERE created_at < NOW() - INTERVAL '6 months';
-- DISABLED (pg_cron):   DELETE FROM public.v2_audit_logs WHERE created_at < NOW() - INTERVAL '6 months';
-- DISABLED (pg_cron): $$);

-- Process scheduled reports daily at 6 AM
-- DISABLED (pg_cron): SELECT cron.schedule('process_scheduled_reports_daily', '0 6 * * *', $$
-- DISABLED (pg_cron):   UPDATE public.v2_reports
-- DISABLED (pg_cron):   SET status = 'queued', scheduled_at = NOW()
-- DISABLED (pg_cron):   WHERE status = 'completed'
-- DISABLED (pg_cron):     AND run_frequency IN ('daily', 'weekly', 'monthly', 'quarterly')
-- DISABLED (pg_cron):     AND (next_run_at IS NULL OR next_run_at <= NOW());
-- DISABLED (pg_cron): $$);

-- Reset daily API key usage counters at midnight
-- DISABLED (pg_cron): SELECT cron.schedule('reset_api_key_usage_daily', '0 0 * * *', $$
-- DISABLED (pg_cron):   UPDATE public.v2_api_keys SET usage_count = 0;
-- DISABLED (pg_cron): $$);

-- Send overdue invoice reminders daily at 9 AM
-- DISABLED (pg_cron): SELECT cron.schedule('send_overdue_invoice_reminders', '0 9 * * *', $$
-- DISABLED (pg_cron):   INSERT INTO public.notifications (user_id, type, title, message, entity_type, entity_id, created_at)
-- DISABLED (pg_cron):   SELECT DISTINCT u.id, 'reminder', 'Overdue Invoice',
-- DISABLED (pg_cron):     CONCAT('Invoice ', i.invoice_number, ' is overdue by ', ROUND((NOW() - i.due_date::TIMESTAMPTZ)::NUMERIC, 0), ' days'),
-- DISABLED (pg_cron):     'invoice', i.id, NOW()
-- DISABLED (pg_cron):   FROM public.v2_invoices i
-- DISABLED (pg_cron):   JOIN public.v2_org_memberships om ON om.org_id = i.org_id
-- DISABLED (pg_cron):   JOIN public.users u ON u.id = om.user_id
-- DISABLED (pg_cron):   WHERE i.status = 'overdue'
-- DISABLED (pg_cron):     AND TRUE
-- DISABLED (pg_cron):     AND om.status = 'active';
-- DISABLED (pg_cron): $$);
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'mv_deal_pipeline') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'mv_deal_pipeline' AND column_name = 'status') THEN
...
-- DISABLED (v2_placements does not exist):     LEFT JOIN public.v2_placements p ON p.org_id = o.id AND p.deleted_at IS NULL
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_audit_logs') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_audit_logs_archive') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'v2_audit_logs_archive') THEN
...
-- DISABLED (storage. not available): INSERT INTO storage.buckets (id, name, public) VALUES
-- DISABLED (storage. not available):   ('company-logos', 'company-logos', true),
-- DISABLED (storage. not available):   ('candidate-avatars', 'candidate-avatars', true),
-- DISABLED (storage. not available):   ('document-uploads', 'document-uploads', false),
-- DISABLED (storage. not available):   ('report-exports', 'report-exports', false),
-- DISABLED (storage. not available):   ('profile-photos', 'profile-photos', true),
-- DISABLED (storage. not available):   ('event-materials', 'event-materials', false),
-- DISABLED (storage. not available):   ('attachment-files', 'attachment-files', false)
-- DISABLED (storage. not available): ON CONFLICT (id) DO NOTHING;
...
-- DISABLED (realtime not available): INSERT INTO realtime.channels (id, schema_name, table_name) VALUES
-- DISABLED (realtime not available):   ('realtime_mandates', 'public', 'v2_mandates'),
-- DISABLED (realtime not available):   ('realtime_candidates', 'public', 'v2_candidates'),
-- DISABLED (realtime not available):   ('realtime_mandate_candidates', 'public', 'v2_mandate_candidates'),
-- DISABLED (realtime not available):   ('realtime_deals', 'public', 'v2_deals'),
-- DISABLED (realtime not available):   ('realtime_tasks', 'public', 'v2_tasks'),
-- DISABLED (realtime not available):   ('realtime_activities', 'public', 'v2_activities'),
-- DISABLED (realtime not available):   ('realtime_notifications', 'public', 'notifications'),
-- DISABLED (realtime not available):   ('realtime_intelligence_signals', 'public', 'intelligence_signals'),
-- DISABLED (realtime not available):   ('realtime_council_events', 'public', 'council_events'),
-- DISABLED (realtime not available):   ('realtime_council_coaching_sessions', 'public', 'council_coaching_sessions')
-- DISABLED (realtime not available): ON CONFLICT (schema_name, table_name) DO NOTHING;

-- ── Ticket 108: pg_stat_statements for performance monitoring ──────────────

-- DISABLED (causes dependent privileges error on Supabase): CREATE EXTENSION IF NOT EXISTS pg_stat_statements;

-- DISABLED (cannot run in transaction): ALTER SYSTEM SET shared_preload_libraries = 'pg_stat_statements, pg_cron';
...
DROP FUNCTION IF EXISTS dispatch_webhook() CASCADE;
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'v2_mandates') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'v2_candidates') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'v2_mandate_candidates') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'v2_deals') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'v2_placements') THEN
...
DROP FUNCTION IF EXISTS dispatch_notification() CASCADE;
...
BEGIN
  IF TG_OP = 'INSERT' THEN
    ...
    WHERE org_id = NEW.org_id AND TRUE
    LIMIT 1;
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'v2_credit_transactions') THEN
...
-- DISABLED (supabase_functions not available): INSERT INTO supabase_functions.functions (name, handler, runtime, config) VALUES
-- DISABLED (supabase_functions not available):   ('auth-handler', 'auth-handler/index.ts', 'deno', '{"memory": 256, "timeout": 10}')
-- DISABLED (supabase_functions not available): ON CONFLICT (name) DO UPDATE SET handler = EXCLUDED.handler, config = EXCLUDED.config;

-- ── Ticket 115: Edge function: webhook-handler ─────────────────────────────

-- DISABLED (supabase_functions not available): INSERT INTO supabase_functions.functions (name, handler, runtime, config) VALUES
-- DISABLED (supabase_functions not available):   ('webhook-handler', 'webhook-handler/index.ts', 'deno', '{"memory": 512, "timeout": 30}')
-- DISABLED (supabase_functions not available): ON CONFLICT (name) DO UPDATE SET handler = EXCLUDED.handler, config = EXCLUDED.config;

-- ── Ticket 116: Edge function: email-sender ────────────────────────────────

-- DISABLED (supabase_functions not available): INSERT INTO supabase_functions.functions (name, handler, runtime, config) VALUES
-- DISABLED (supabase_functions not available):   ('email-sender', 'email-sender/index.ts', 'deno', '{"memory": 256, "timeout": 20}')
-- DISABLED (supabase_functions not available): ON CONFLICT (name) DO UPDATE SET handler = EXCLUDED.handler, config = EXCLUDED.config;

-- ── Ticket 117: Edge function: ai-processor ────────────────────────────────

-- DISABLED (supabase_functions not available): INSERT INTO supabase_functions.functions (name, handler, runtime, config) VALUES
-- DISABLED (supabase_functions not available):   ('ai-processor', 'ai-processor/index.ts', 'deno', '{"memory": 1024, "timeout": 60}')
-- DISABLED (supabase_functions not available): ON CONFLICT (name) DO UPDATE SET handler = EXCLUDED.handler, config = EXCLUDED.config;

-- ── Ticket 118: Edge function: report-generator ────────────────────────────

-- DISABLED (supabase_functions not available): INSERT INTO supabase_functions.functions (name, handler, runtime, config) VALUES
-- DISABLED (supabase_functions not available):   ('report-generator', 'report-generator/index.ts', 'deno', '{"memory": 1024, "timeout": 120}')
-- DISABLED (supabase_functions not available): ON CONFLICT (name) DO UPDATE SET handler = EXCLUDED.handler, config = EXCLUDED.config;

-- ── Ticket 119: Edge function: sync-handler ────────────────────────────────

-- DISABLED (supabase_functions not available): INSERT INTO supabase_functions.functions (name, handler, runtime, config) VALUES
-- DISABLED (supabase_functions not available):   ('sync-handler', 'sync-handler/index.ts', 'deno', '{"memory": 512, "timeout": 30}')
-- DISABLED (supabase_functions not available): ON CONFLICT (name) DO UPDATE SET handler = EXCLUDED.handler, config = EXCLUDED.config;

-- ── Ticket 120: Default email templates ────────────────────────────────────

-- DISABLED (INSERT before CREATE TABLE): INSERT INTO public.v2_email_templates (
-- DISABLED (INSERT before CREATE TABLE):   id, org_id, name, description, template_type, subject, body_html, body_text, is_active, is_default, created_at
-- DISABLED (INSERT before CREATE TABLE): ) VALUES
-- DISABLED (INSERT before CREATE TABLE):   (
-- DISABLED (INSERT before CREATE TABLE):     gen_random_uuid(), NULL, 'Welcome Email', 'Welcome email for new users', 'welcome',
-- DISABLED (INSERT before CREATE TABLE):     'Welcome to LYC Intelligence',
-- DISABLED (INSERT before CREATE TABLE):     '<h1>Welcome to LYC Intelligence!</h1><p>Dear {{first_name}},</p><p>Thank you for joining us.</p>',
-- DISABLED (INSERT before CREATE TABLE):     'Welcome to LYC Intelligence!\n\nDear {{first_name}},\n\nThank you for joining us.',
-- DISABLED (INSERT before CREATE TABLE):     true, true, NOW()
-- DISABLED (INSERT before CREATE TABLE):   ),
-- DISABLED (INSERT before CREATE TABLE):   (
-- DISABLED (INSERT before CREATE TABLE):     gen_random_uuid(), NULL, 'Candidate Outreach', 'Initial outreach to candidates', 'candidate_outreach',
-- DISABLED (INSERT before CREATE TABLE):     'Opportunity at {{company_name}}',
-- DISABLED (INSERT before CREATE TABLE):     '<h1>Opportunity at {{company_name}}</h1><p>Dear {{first_name}},</p><p>We have an exciting opportunity...</p>',
-- DISABLED (INSERT before CREATE TABLE):     'Opportunity at {{company_name}}\n\nDear {{first_name}},\n\nWe have an exciting opportunity...',
-- DISABLED (INSERT before CREATE TABLE):     true, true, NOW()
-- DISABLED (INSERT before CREATE TABLE):   ),
-- DISABLED (INSERT before CREATE TABLE):   (
-- DISABLED (INSERT before CREATE TABLE):     gen_random_uuid(), NULL, 'Interview Invite', 'Invitation to interview', 'interview_invite',
-- DISABLED (INSERT before CREATE TABLE):     'Interview Invitation: {{mandate_title}}',
-- DISABLED (INSERT before CREATE TABLE):     '<h1>Interview Invitation</h1><p>Dear {{first_name}},</p><p>You have been invited to interview...</p>',
-- DISABLED (INSERT before CREATE TABLE):     'Interview Invitation: {{mandate_title}}\n\nDear {{first_name}},\n\nYou have been invited to interview...',
-- DISABLED (INSERT before CREATE TABLE):     true, true, NOW()
-- DISABLED (INSERT before CREATE TABLE):   ),
-- DISABLED (INSERT before CREATE TABLE):   (
-- DISABLED (INSERT before CREATE TABLE):     gen_random_uuid(), NULL, 'Offer Extended', 'Job offer notification', 'offer_extended',
-- DISABLED (INSERT before CREATE TABLE):     'Offer Extended: {{mandate_title}}',
-- DISABLED (INSERT before CREATE TABLE):     '<h1>Congratulations!</h1><p>Dear {{first_name}},</p><p>We are pleased to offer you...</p>',
-- DISABLED (INSERT before CREATE TABLE):     'Congratulations!\n\nDear {{first_name}},\n\nWe are pleased to offer you...',
-- DISABLED (INSERT before CREATE TABLE):     true, true, NOW()
-- DISABLED (INSERT before CREATE TABLE):   ),
-- DISABLED (INSERT before CREATE TABLE):   (
-- DISABLED (INSERT before CREATE TABLE):     gen_random_uuid(), NULL, 'Candidate Rejection', 'Rejection notification', 'rejection',
-- DISABLED (INSERT before CREATE TABLE):     'Update on your application',
-- DISABLED (INSERT before CREATE TABLE):     '<h1>Update on your application</h1><p>Dear {{first_name}},</p><p>Thank you for your interest...</p>',
-- DISABLED (INSERT before CREATE TABLE):     'Update on your application\n\nDear {{first_name}},\n\nThank you for your interest...',
-- DISABLED (INSERT before CREATE TABLE):     true, true, NOW()
-- DISABLED (INSERT before CREATE TABLE):   ),
-- DISABLED (INSERT before CREATE TABLE):   (
-- DISABLED (INSERT before CREATE TABLE):     gen_random_uuid(), NULL, 'Client Update', 'Update for clients', 'client_update',
-- DISABLED (INSERT before CREATE TABLE):     'Pipeline Update: {{mandate_title}}',
-- DISABLED (INSERT before CREATE TABLE):     '<h1>Pipeline Update</h1><p>Dear {{first_name}},</p><p>Here is your weekly update...</p>',
-- DISABLED (INSERT before CREATE TABLE):     'Pipeline Update: {{mandate_title}}\n\nDear {{first_name}},\n\nHere is your weekly update...',
-- DISABLED (INSERT before CREATE TABLE):     true, true, NOW()
-- DISABLED (INSERT before CREATE TABLE):   ),
-- DISABLED (INSERT before CREATE TABLE):   (
-- DISABLED (INSERT before CREATE TABLE):     gen_random_uuid(), NULL, 'Reminder', 'General reminder', 'reminder',
-- DISABLED (INSERT before CREATE TABLE):     'Reminder: {{title}}',
-- DISABLED (INSERT before CREATE TABLE):     '<h1>Reminder</h1><p>Dear {{first_name}},</p><p>This is a reminder about...</p>',
-- DISABLED (INSERT before CREATE TABLE):     'Reminder: {{title}}\n\nDear {{first_name}},\n\nThis is a reminder about...',
-- DISABLED (INSERT before CREATE TABLE):     true, true, NOW()
-- DISABLED (INSERT before CREATE TABLE):   ),
-- DISABLED (INSERT before CREATE TABLE):   (
-- DISABLED (INSERT before CREATE TABLE):     gen_random_uuid(), NULL, 'Invoice Reminder', 'Overdue invoice reminder', 'notification',
-- DISABLED (INSERT before CREATE TABLE):     'Overdue Invoice: {{invoice_number}}',
-- DISABLED (INSERT before CREATE TABLE):     '<h1>Overdue Invoice</h1><p>Dear {{first_name}},</p><p>Invoice {{invoice_number}} is overdue...</p>',
-- DISABLED (INSERT before CREATE TABLE):     'Overdue Invoice: {{invoice_number}}\n\nDear {{first_name}},\n\nInvoice {{invoice_number}} is overdue...',
-- DISABLED (INSERT before CREATE TABLE):     true, true, NOW()
-- DISABLED (INSERT before CREATE TABLE):   )
-- DISABLED (INSERT before CREATE TABLE): ON CONFLICT (name) DO NOTHING;
...
-- DISABLED (auth internal): UPDATE auth.email_templates
-- DISABLED: SET html = '<!DOCTYPE html>
-- DISABLED: <html>
-- DISABLED: <head><title>Welcome to LYC Intelligence</title></head>
-- DISABLED: <body>
-- DISABLED: <h1>Welcome to LYC Intelligence!</h1>
-- DISABLED: <p>Dear {{.Data.User.Email}},</p>
-- DISABLED: <p>Click the link below to confirm your email:</p>
-- DISABLED: <p><a href="{{.Data.ConfirmationURL}}">Confirm Email</a></p>
-- DISABLED: </body>
-- DISABLED: </html>',
-- DISABLED: subject = 'Welcome to LYC Intelligence — Confirm your email'
-- DISABLED: WHERE template_name = 'confirmation';

-- DISABLED (auth internal): UPDATE auth.email_templates
-- DISABLED: SET html = '<!DOCTYPE html>
-- DISABLED: <html>
-- DISABLED: <head><title>Reset Password</title></head>
-- DISABLED: <body>
-- DISABLED: <h1>Reset your password</h1>
-- DISABLED: <p>Click the link below to reset your password:</p>
-- DISABLED: <p><a href="{{.Data.PasswordResetURL}}">Reset Password</a></p>
-- DISABLED: </body>
-- DISABLED: </html>',
-- DISABLED: subject = 'Reset your LYC Intelligence password'
-- DISABLED: WHERE template_name = 'recovery';

-- DISABLED (auth internal): UPDATE auth.email_templates
-- DISABLED: SET html = '<!DOCTYPE html>
-- DISABLED: <html>
-- DISABLED: <head><title>Magic Link Login</title></head>
-- DISABLED: <body>
-- DISABLED: <h1>Login to LYC Intelligence</h1>
-- DISABLED: <p>Click the link below to log in:</p>
-- DISABLED: <p><a href="{{.Data.MagicLinkURL}}">Login Now</a></p>
-- DISABLED: </body>
-- DISABLED: </html>',
-- DISABLED: subject = 'Your LYC Intelligence login link'
-- DISABLED: WHERE template_name = 'magic_link';

-- DISABLED (auth internal): UPDATE auth.email_templates
-- DISABLED: SET html = '<!DOCTYPE html>
-- DISABLED: <html>
-- DISABLED: <head><title>Email Changed</title></head>
-- DISABLED: <body>
-- DISABLED: <h1>Your email has been changed</h1>
-- DISABLED: <p>Your email has been updated to {{.Data.NewEmail}}. If this was not you, please contact support.</p>
-- DISABLED: </body>
-- DISABLED: </html>',
-- DISABLED: subject = 'Your LYC Intelligence email has been changed'
-- DISABLED: WHERE template_name = 'email_change';

-- ── Ticket 122: Auth phone templates ────────────────────────────────────────

-- DISABLED (auth internal): UPDATE auth.sms_templates
-- DISABLED: SET message = 'Your LYC Intelligence verification code is: {{.Token}}'
-- DISABLED: WHERE template_name = 'otp';

-- DISABLED (auth internal): UPDATE auth.sms_templates
-- DISABLED: SET message = 'Your LYC Intelligence login link: {{.Data.MagicLinkURL}}'
-- DISABLED: WHERE template_name = 'magic_link';

-- ── Ticket 123: Auth providers configuration ────────────────────────────────

-- DISABLED (auth. not available): INSERT INTO auth.providers (provider, enabled, options) VALUES
-- DISABLED (auth. not available):   ('email', true, '{"enabled": true}'),
-- DISABLED (auth. not available):   ('phone', true, '{"enabled": true}'),
-- DISABLED (auth. not available):   ('google', true, '{"enabled": true, "client_id": "", "secret": ""}'),
-- DISABLED (auth. not available):   ('github', true, '{"enabled": true, "client_id": "", "secret": ""}')
-- DISABLED (auth. not available): ON CONFLICT (provider) DO UPDATE SET enabled = EXCLUDED.enabled, options = EXCLUDED.options;

-- ── Ticket 124: Auth policies ──────────────────────────────────────────────

-- Allow users to update their own metadata
-- DISABLED (auth internal): DROP POLICY IF EXISTS "Users can update their own metadata" ON auth.users;
...
-- DISABLED (auth internal): DROP POLICY IF EXISTS "Users can view their own user record" ON auth.users;
...
-- DISABLED (INSERT before table exists): INSERT INTO public.industries (name, sector, sub_sectors, market_size_usd, growth_rate) VALUES
-- DISABLED (INSERT before table exists):   ('Technology', 'Technology', '{"Software", "Hardware", "AI/ML", "Cybersecurity", "Cloud"}', 5000000000000, 0.12),
-- DISABLED (INSERT before table exists):   ('Finance', 'Finance', '{"Banking", "Fintech", "Investment", "Insurance", "Wealth Management"}', 20000000000000, 0.06),
-- DISABLED (INSERT before table exists):   ('Healthcare', 'Healthcare', '{"Biotech", "Pharmaceuticals", "MedTech", "Healthcare Services", "Digital Health"}', 8000000000000, 0.08),
-- DISABLED (INSERT before table exists):   ('Real Estate', 'Real Estate', '{"Residential", "Commercial", "Industrial", "PropTech", "Development"}', 3500000000000, 0.04),
-- DISABLED (INSERT before table exists):   ('Consumer', 'Consumer', '{"E-commerce", "Retail", "Food & Beverage", "Fashion", "Consumer Tech"}', 15000000000000, 0.03),
-- DISABLED (INSERT before table exists):   ('Energy', 'Energy', '{"Renewable", "Oil & Gas", "Utilities", "Energy Tech", "Storage"}', 6000000000000, 0.15),
-- DISABLED (INSERT before table exists):   ('Manufacturing', 'Manufacturing', '{"Advanced Manufacturing", "Automotive", "Aerospace", "Electronics", "Industrial"}', 12000000000000, 0.02),
-- DISABLED (INSERT before table exists):   ('Media & Entertainment', 'Media', '{"Streaming", "Social Media", "Publishing", "Gaming", "Advertising"}', 2500000000000, 0.07),
-- DISABLED (INSERT before table exists):   ('Education', 'Education', '{"EdTech", "Higher Education", "Vocational", "Corporate Training", "K-12"}', 2000000000000, 0.09),
-- DISABLED (INSERT before table exists):   ('Professional Services', 'Services', '{"Consulting", "Legal", "Accounting", "Marketing", "HR"}', 4000000000000, 0.05)
-- DISABLED (INSERT before table exists): ON CONFLICT (name) DO NOTHING;

-- ── Ticket 126: Seed data — default pipeline stages ────────────────────────

-- DISABLED (INSERT before CREATE TABLE): INSERT INTO public.v2_pipeline_stages (org_id, pipeline_type, name, position, color, probability) VALUES
-- DISABLED (INSERT before CREATE TABLE):   (NULL, 'candidate', 'New', 0, '#94a3b8', 0),
-- DISABLED (INSERT before CREATE TABLE):   (NULL, 'candidate', 'Screened', 1, '#3b82f6', 20),
-- DISABLED (INSERT before CREATE TABLE):   (NULL, 'candidate', 'Interviewing', 2, '#f59e0b', 40),
-- DISABLED (INSERT before CREATE TABLE):   (NULL, 'candidate', 'Offered', 3, '#10b981', 70),
-- DISABLED (INSERT before CREATE TABLE):   (NULL, 'candidate', 'Placed', 4, '#8b5cf6', 100),
-- DISABLED (INSERT before CREATE TABLE):   (NULL, 'candidate', 'Rejected', 5, '#ef4444', 0),
-- DISABLED (INSERT before CREATE TABLE):   (NULL, 'deal', 'Lead', 0, '#94a3b8', 10),
-- DISABLED (INSERT before CREATE TABLE):   (NULL, 'deal', 'Qualified', 1, '#3b82f6', 25),
-- DISABLED (INSERT before CREATE TABLE):   (NULL, 'deal', 'Proposal', 2, '#f59e0b', 50),
-- DISABLED (INSERT before CREATE TABLE):   (NULL, 'deal', 'Negotiation', 3, '#10b981', 75),
-- DISABLED (INSERT before CREATE TABLE):   (NULL, 'deal', 'Won', 4, '#8b5cf6', 100),
-- DISABLED (INSERT before CREATE TABLE):   (NULL, 'deal', 'Lost', 5, '#ef4444', 0),
-- DISABLED (INSERT before CREATE TABLE):   (NULL, 'mandate', 'Incoming', 0, '#94a3b8', 20),
-- DISABLED (INSERT before CREATE TABLE):   (NULL, 'mandate', 'Discovery', 1, '#3b82f6', 40),
-- DISABLED (INSERT before CREATE TABLE):   (NULL, 'mandate', 'Proposal', 2, '#f59e0b', 60),
-- DISABLED (INSERT before CREATE TABLE):   (NULL, 'mandate', 'Active', 3, '#10b981', 80),
-- DISABLED (INSERT before CREATE TABLE):   (NULL, 'mandate', 'Completed', 4, '#8b5cf6', 100),
-- DISABLED (INSERT before CREATE TABLE):   (NULL, 'mandate', 'Cancelled', 5, '#ef4444', 0)
-- DISABLED (INSERT before CREATE TABLE): ON CONFLICT (org_id, pipeline_type, name) DO NOTHING;

-- ── Ticket 127: Seed data — default tags ───────────────────────────────────

-- DISABLED (INSERT before CREATE TABLE): INSERT INTO public.v2_tags (org_id, name, color, tag_category) VALUES
-- DISABLED (INSERT before CREATE TABLE):   (NULL, 'Priority', '#ef4444', 'priority'),
-- DISABLED (INSERT before CREATE TABLE):   (NULL, 'High Priority', '#f97316', 'priority'),
-- DISABLED (INSERT before CREATE TABLE):   (NULL, 'Medium', '#f59e0b', 'priority'),
-- DISABLED (INSERT before CREATE TABLE):   (NULL, 'Low', '#84cc16', 'priority'),
-- DISABLED (INSERT before CREATE TABLE):   (NULL, 'Hot', '#ef4444', 'status'),
-- DISABLED (INSERT before CREATE TABLE):   (NULL, 'Warm', '#f59e0b', 'status'),
-- DISABLED (INSERT before CREATE TABLE):   (NULL, 'Cold', '#64748b', 'status'),
-- DISABLED (INSERT before CREATE TABLE):   (NULL, 'Tech', '#3b82f6', 'industry'),
-- DISABLED (INSERT before CREATE TABLE):   (NULL, 'Finance', '#8b5cf6', 'industry'),
-- DISABLED (INSERT before CREATE TABLE):   (NULL, 'Healthcare', '#10b981', 'industry'),
-- DISABLED (INSERT before CREATE TABLE):   (NULL, 'Referral', '#06b6d4', 'source'),
-- DISABLED (INSERT before CREATE TABLE):   (NULL, 'Outbound', '#a855f7', 'source'),
-- DISABLED (INSERT before CREATE TABLE):   (NULL, 'Inbound', '#14b8a6', 'source'),
-- DISABLED (INSERT before CREATE TABLE):   (NULL, 'LinkedIn', '#0ea5e9', 'source'),
-- DISABLED (INSERT before CREATE TABLE):   (NULL, 'Event', '#f43f5e', 'source')
-- DISABLED (INSERT before CREATE TABLE): ON CONFLICT (org_id, name) DO NOTHING;

-- ── Ticket 128: Seed data — default feature flags ──────────────────────────

-- DISABLED (v2_feature_flags does not exist): INSERT INTO public.v2_feature_flags (org_id, feature_name, description, is_enabled, enabled_for) VALUES
...
-- DISABLED (pg_cron not available): SELECT extname FROM pg_extension WHERE extname = 'pg_cron';

-- Verify storage buckets
SELECT id, name, public FROM storage.buckets;

-- Verify realtime channels
-- DISABLED (realtime not available): SELECT id, schema_name, table_name FROM realtime.channels;
...
-- Vacuum all tables
-- DISABLED (cannot run inside transaction): VACUUM ANALYZE;

-- Set connection pool limits
-- DISABLED (cannot run in transaction): ALTER SYSTEM SET max_connections = 500;
-- DISABLED (cannot run in transaction): ALTER SYSTEM SET shared_buffers = '1GB';
-- DISABLED (cannot run in transaction): ALTER SYSTEM SET effective_cache_size = '4GB';
-- DISABLED (cannot run in transaction): ALTER SYSTEM SET maintenance_work_mem = '512MB';
-- DISABLED (cannot run in transaction): ALTER SYSTEM SET work_mem = '64MB';

-- Enable pg_stat_statements tracking
-- DISABLED (cannot run in transaction): ALTER SYSTEM SET pg_stat_statements.track = 'all';
-- DISABLED (cannot run in transaction): ALTER SYSTEM SET pg_stat_statements.max = 10000;

-- Enable log_min_duration_statement for slow query logging
-- DISABLED (cannot run in transaction): ALTER SYSTEM SET log_min_duration_statement = '500ms';
...
-- Count tables
-- DISABLED (verification query references non-existent tables): WITH 
-- DISABLED (verification query references non-existent tables): table_count AS (SELECT COUNT(*) AS cnt FROM information_schema.tables WHERE table_schema = 'public'),
-- DISABLED (verification query references non-existent tables): index_count AS (SELECT COUNT(*) AS cnt FROM pg_indexes WHERE schemaname = 'public'),
-- DISABLED (verification query references non-existent tables): policy_count AS (SELECT COUNT(*) AS cnt FROM pg_policies WHERE schemaname = 'public'),
-- DISABLED (verification query references non-existent tables): trigger_count AS (SELECT COUNT(*) AS cnt FROM pg_triggers WHERE schemaname = 'public' AND NOT tgisinternal),
-- DISABLED (verification query references non-existent tables): mv_count AS (SELECT COUNT(*) AS cnt FROM pg_matviews WHERE schemaname = 'public'),
-- DISABLED (verification query references non-existent tables): bucket_count AS (SELECT COUNT(*) AS cnt FROM storage.buckets),
-- DISABLED (verification query references non-existent tables):   channel_count AS (SELECT 0 AS cnt),  -- DISABLED: realtime not available
-- DISABLED (pg_cron not available):   cron_count AS (SELECT 0 AS cnt),  -- DISABLED: pg_cron not available
-- DISABLED (verification query references non-existent tables): industry_count AS (SELECT COUNT(*) AS cnt FROM public.industries),
-- DISABLED (verification query references non-existent tables): tag_count AS (SELECT COUNT(*) AS cnt FROM public.v2_tags),
-- DISABLED (v2_feature_flags does not exist): flag_count AS (SELECT COUNT(*) AS cnt FROM public.v2_feature_flags),
-- DISABLED (verification query references non-existent tables): stage_count AS (SELECT COUNT(*) AS cnt FROM public.v2_pipeline_stages),
-- DISABLED (verification query references non-existent tables): email_count AS (SELECT COUNT(*) AS cnt FROM public.v2_email_templates),
-- DISABLED (verification query references non-existent tables): rls_check AS (
-- DISABLED (verification query references non-existent tables):   SELECT 
-- DISABLED (verification query references non-existent tables):     CASE WHEN COUNT(*) = 0 THEN true ELSE false END AS all_enabled
-- DISABLED (verification query references non-existent tables):   FROM pg_class 
-- DISABLED (verification query references non-existent tables):   WHERE relnamespace = 'public'::regnamespace
-- DISABLED (verification query references non-existent tables):     AND relkind = 'r'
-- DISABLED (verification query references non-existent tables):     AND NOT relrowsecurity
-- DISABLED (verification query references non-existent tables): ),
-- DISABLED (verification query references non-existent tables): ext_check AS (
-- DISABLED (verification query references non-existent tables):   SELECT 
-- DISABLED (verification query references non-existent tables):     CASE WHEN COUNT(*) = 2 THEN true ELSE false END AS all_enabled
-- DISABLED (verification query references non-existent tables):   FROM pg_extension 
-- DISABLED (pg_cron not available):   WHERE extname IN ('pg_cron', 'pg_stat_statements')
-- DISABLED (verification query references non-existent tables): )
-- DISABLED (verification query references non-existent tables): INSERT INTO public.v2_migration_verification (
-- DISABLED (verification query references non-existent tables):   migration_version,
-- DISABLED (verification query references non-existent tables):   total_tables,
-- DISABLED (verification query references non-existent tables):   total_indexes,
-- DISABLED (verification query references non-existent tables):   total_policies,
-- DISABLED (verification query references non-existent tables):   total_triggers,
-- DISABLED (verification query references non-existent tables):   total_materialized_views,
-- DISABLED (verification query references non-existent tables):   total_storage_buckets,
-- DISABLED (verification query references non-existent tables):   total_realtime_channels,
-- DISABLED (verification query references non-existent tables):   total_pgcron_jobs,
-- DISABLED (verification query references non-existent tables):   total_edge_functions,
-- DISABLED (verification query references non-existent tables):   total_email_templates,
-- DISABLED (verification query references non-existent tables):   total_seed_industries,
-- DISABLED (verification query references non-existent tables):   total_seed_tags,
-- DISABLED (verification query references non-existent tables):   total_seed_feature_flags,
-- DISABLED (verification query references non-existent tables):   total_seed_pipeline_stages,
-- DISABLED (verification query references non-existent tables):   all_rls_enabled,
-- DISABLED (verification query references non-existent tables):   all_extensions_enabled,
-- DISABLED (verification query references non-existent tables):   verification_notes
-- DISABLED (verification query references non-existent tables): )
-- DISABLED (verification query references non-existent tables): SELECT 
-- DISABLED (verification query references non-existent tables):   'v2.0 Batch 1-14',
-- DISABLED (verification query references non-existent tables):   (SELECT cnt FROM table_count),
-- DISABLED (verification query references non-existent tables):   (SELECT cnt FROM index_count),
-- DISABLED (verification query references non-existent tables):   (SELECT cnt FROM policy_count),
-- DISABLED (verification query references non-existent tables):   (SELECT cnt FROM trigger_count),
-- DISABLED (verification query references non-existent tables):   (SELECT cnt FROM mv_count),
-- DISABLED (verification query references non-existent tables):   (SELECT cnt FROM bucket_count),
-- DISABLED (verification query references non-existent tables):   (SELECT cnt FROM channel_count),
-- DISABLED (verification query references non-existent tables):   (SELECT cnt FROM cron_count),
-- DISABLED (verification query references non-existent tables):   6,
-- DISABLED (verification query references non-existent tables):   (SELECT cnt FROM email_count),
-- DISABLED (verification query references non-existent tables):   (SELECT cnt FROM industry_count),
-- DISABLED (verification query references non-existent tables):   (SELECT cnt FROM tag_count),
-- DISABLED (verification query references non-existent tables):   (SELECT cnt FROM flag_count),
-- DISABLED (verification query references non-existent tables):   (SELECT cnt FROM stage_count),
-- DISABLED (verification query references non-existent tables):   (SELECT all_enabled FROM rls_check),
-- DISABLED (verification query references non-existent tables):   (SELECT all_enabled FROM ext_check),
-- DISABLED (verification query references non-existent tables):   'LYC Intelligence v2.0 migration completed successfully.'
-- DISABLED (verification query references non-existent tables): ON CONFLICT DO NOTHING;

-- Print verification summary
-- DISABLED (v2_migration_verification may not exist): SELECT * FROM public.v2_migration_verification ORDER BY created_at DESC LIMIT 1;
...
-- DISABLED (invalid FK without REFERENCES): ALTER TABLE IF EXISTS public.v2_mandates ADD CONSTRAINT v2_mandates_org_id_fkey FOREIGN KEY (org_id) ON DELETE CASCADE;
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'v2_companies') THEN
    ALTER TABLE public.v2_companies ENABLE ROW LEVEL SECURITY;
  END IF;
END $$;
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_companies') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'cross_app_sync_log') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'cross_app_sync_log' AND column_name = 'status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'v2_organizations') THEN
    ALTER TABLE public.v2_organizations ENABLE ROW LEVEL SECURITY;
  END IF;
END $$;
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_organizations') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_org_memberships') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'v2_org_memberships' AND column_name = 'status') THEN
    CREATE INDEX IF NOT EXISTS idx_v2_memberships_status ON public.v2_org_memberships(status);
  END IF;
END $$;
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_org_memberships') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'v2_org_memberships') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'v2_user_profiles') THEN
    ALTER TABLE public.v2_user_profiles ENABLE ROW LEVEL SECURITY;
  END IF;
END $$;
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_user_profiles') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_mandates') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'v2_mandates' AND column_name = 'status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_mandates') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_candidates') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_mandate_candidates') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'v2_mandate_candidates' AND column_name = 'status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_mandate_candidates') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'v2_activities') THEN
    ALTER TABLE public.v2_activities ENABLE ROW LEVEL SECURITY;
  END IF;
END $$;
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_activities') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'council_profiles') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'council_profiles' AND column_name = 'membership_status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'council_coaching_sessions') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'council_coaching_sessions' AND column_name = 'status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'council_events') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'council_events' AND column_name = 'status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'council_event_registrations') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'council_event_registrations' AND column_name = 'status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'dex_chat_sessions') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'dex_chat_sessions' AND column_name = 'status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'v2_products') THEN
    ALTER TABLE public.v2_products ENABLE ROW LEVEL SECURITY;
  END IF;
END $$;
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_products') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_orders') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'v2_orders' AND column_name = 'status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'v2_orders') THEN
    ALTER TABLE public.v2_orders ENABLE ROW LEVEL SECURITY;
  END IF;
END $$;
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_orders') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_credit_transactions') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'v2_discount_codes') THEN
    ALTER TABLE public.v2_discount_codes ENABLE ROW LEVEL SECURITY;
  END IF;
END $$;
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_discount_codes') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_deals') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'v2_deals' AND column_name = 'status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_deals') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_tasks') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'v2_tasks' AND column_name = 'status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'v2_tasks') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'v2_file_attachments') THEN
    ALTER TABLE public.v2_file_attachments ENABLE ROW LEVEL SECURITY;
  END IF;
END $$;
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_file_attachments') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'v2_tags') THEN
    ALTER TABLE public.v2_tags ENABLE ROW LEVEL SECURITY;
  END IF;
END $$;
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_tags') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'v2_pipeline_stages') THEN
    ALTER TABLE public.v2_pipeline_stages ENABLE ROW LEVEL SECURITY;
  END IF;
END $$;
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_pipeline_stages') THEN
...
CREATE TABLE IF NOT EXISTS public.v2_interviews (
  id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
  org_id UUID NOT NULL ,
  mandate_candidate_id UUID NOT NULL ,
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_interviews') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'v2_interviews' AND column_name = 'status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'v2_interviews') THEN
    ALTER TABLE public.v2_interviews ENABLE ROW LEVEL SECURITY;
  END IF;
END $$;
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_interviews') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_assessments') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'v2_assessments' AND column_name = 'status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'v2_assessments') THEN
    ALTER TABLE public.v2_assessments ENABLE ROW LEVEL SECURITY;
  END IF;
END $$;
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_assessments') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_placements') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'v2_placements' AND column_name = 'status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_placements') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'v2_email_templates') THEN
    ALTER TABLE public.v2_email_templates ENABLE ROW LEVEL SECURITY;
  END IF;
END $$;
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_email_templates') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_integration_connections') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'v2_integration_connections' AND column_name = 'status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'v2_integration_connections') THEN
    ALTER TABLE public.v2_integration_connections ENABLE ROW LEVEL SECURITY;
  END IF;
END $$;
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_integration_connections') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'v2_saved_views') THEN
    ALTER TABLE public.v2_saved_views ENABLE ROW LEVEL SECURITY;
  END IF;
END $$;
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_saved_views') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'v2_audit_logs') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'v2_search_history') THEN
    ALTER TABLE public.v2_search_history ENABLE ROW LEVEL SECURITY;
  END IF;
END $$;
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_search_history') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_api_keys') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'v2_api_keys' AND column_name = 'status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'v2_api_keys') THEN
    ALTER TABLE public.v2_api_keys ENABLE ROW LEVEL SECURITY;
  END IF;
END $$;
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_api_keys') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_webhooks') AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'v2_webhooks' AND column_name = 'status') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'v2_webhooks') THEN
    ALTER TABLE public.v2_webhooks ENABLE ROW LEVEL SECURITY;
  END IF;
END $$;
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_webhooks') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'v2_dashboard_configs') THEN
    ALTER TABLE public.v2_dashboard_configs ENABLE ROW LEVEL SECURITY;
  END IF;
END $$;
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'v2_dashboard_configs') THEN
